...
import { Upload, FileText, Clock, HelpCircle, Tag, Type, AlignLeft, Calendar, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="max-w-lg mx-auto animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-[var(--text-tertiary)] text-[13px] mt-1">Upload a study PDF to auto-generate a test</p>
      </div>
